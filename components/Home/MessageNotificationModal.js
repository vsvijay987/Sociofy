      ...
      >
        ...
        <Modal.Content>
          <div className="bubbleWrapper">
            ...
            <div className="otherBubble other font-link">
              {newMessageReceived.msg}
            </div>

            <span className="other" className="font-link">
          ...
          <div style={{ marginTop: "5px", fontFamily: "Josefin Sans" }}>
            ...
            {/* <Instructions username={user.email} /> */}
          </div>
        </Modal.Content>
      </Modal>
    </>
